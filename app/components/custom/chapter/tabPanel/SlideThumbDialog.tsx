...
import {DataSlide} from "@/app/types/block";
...
type props = {
  ...
  blockIndex?: number,
  addNewBlocks: any,
  setAddNewBlocks: React.Dispatch<SetStateAction<any>>
}

function SlideThumbDialog({data, setOpen, setDummyAdd, blockIndex, addNewBlocks, setAddNewBlocks}: props) {
  const settings = {
  ...
  const addSlide = () => {
    ...
    if (blockIndex == undefined) {
        setBlocks([...blocks,
          newBlockData('slide', getCharInBlock(selectedCharacter), '', data, showSlideId),
...
export default SlideThumbDialog;
