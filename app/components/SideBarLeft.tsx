...
// import {navSidebar} from "@src/common/data/ScenarioData";
// import MenuItem from "@src/components/Layout/MenuItem";
// import {useAtom} from "jotai";
// import {userAtomWithStorage} from "@src/store/atom/user.atom";
// import {topLeftMenuOpen} from "@src/store/atom/useTopLeftMenuOpen";
// import DialogCustom from "@src/components/DialogCustom";
// import InputCustom from "@src/components/DialogCustom/InputCustom";
// import {handleUploadFile} from "@src/common/uploadImage/handleUploadFile";
import CircularProgress from "@mui/material/CircularProgress";
// import {updateStudio} from "@src/common/commonApis/studio";
import {toast} from "react-toastify";
// import useStudio from "@src/hooks/useStudios";
// import isURL from "validator/lib/isURL";
import {KeyboardDoubleArrowLeft, KeyboardDoubleArrowRight} from "@mui/icons-material";
// import {isCF, isProd, isSuperAdmin, plans} from "@src/configs/constants";
...
const Sidebar = ({children}: Props) => {
    ...
    return (
        <div>
            ...
            {/*{*/}
            {/*    open &&*/}
            {/*    <div className='fixed top-0 right-0 left-0 bottom-0 bg-black/30 z-20 md:hidden' onClick={() => setOpen(false)}>*/}
